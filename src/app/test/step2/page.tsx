    ...
    return (
        <Stack gap={'lg'}>
            ...
            <Blockquote color="blue" icon={<IconInfoCircle />} >
                เมื่อใช้คอมพิวเตอร์หรือใช้งานหน้าจอโทรศัพท์เป็นเวลานาน ควรพักสายตาทุก ๆ 20 นาที โดยใช้วิธีการมองออกไปไกล ๆ การมองในระยะไกลจะช่วยลดการเพ่งของสายตาที่ใช้งานอย่างหนักได้ การเพ่งสายตาเป็นระยะเวลานาน อาจส่งผลต่อสุขภาพในด้านอื่น ๆ ได้อีก เช่น อาการปวดศรีษะ น้ำตาไหล ตาพร่ามัว และมีอาการตาแห้งตามมา
            </Blockquote>
        </Stack >
    )
}
